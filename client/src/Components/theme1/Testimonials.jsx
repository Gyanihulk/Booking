...
const Testimonials = () => {
    ...
    {TestimonialTexts.feedBacks.map((feedBack, index) => (
        <div key={index} className="w-full">
            <Card
                cardClass="bg-white shadow border-[1px] border-color3/10 relative rounded-xl p-4 h-[260px] lg:mb-4 w-full"
                imageAlt={feedBack.person}
                imageSrc={feedBack.img}
                imageWrapperClass="w-20 h-20 rounded-full absolute bottom-3 right-4 overflow-hidden"
